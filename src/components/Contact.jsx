            ...
            <Card.Body className="p-4">
              ...
              <div className="d-flex align-items-center mb-4">
                ...
                <div>
                  ...
                  <p className="mb-0">
                    <a href="mailto:shivtrent800@gmail.com" style={{ textDecoration: 'none', color: 'inherit' }}>
                      shivtrent800@gmail.com
                    </a>
                  </p>
                </div>
              ...
              <div className="d-flex align-items-center">
                ...
                <div>
                  ...
                  <p className="mb-0">
                    <a href="https://github.com/ShivamSoni1995" target="_blank" rel="noopener noreferrer">
                      github.com/ShivamSoni1995
                    </a>
                  </p>
                </div>
              </div>
