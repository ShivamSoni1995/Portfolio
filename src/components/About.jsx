        ...
        <Col lg={8} className="mx-auto">
          <Card className="border-0 shadow-sm">
            <Card.Body className="p-5" style={{ textAlign: 'justify' }}>
              <p className="lead">
                Hello, I’m Shivam Soni, an aspiring DevOps Engineer passionate about automation, cloud computing, and designing scalable infrastructure.
              </p>
              ...
              <p>
                I document my learning journey and insights on <a href="https://shivtrent.hashnode.dev/" target="_blank" rel="noopener noreferrer"><u>Hashnode</u></a>, sharing practical solutions and challenges encountered in the DevOps space.
              </p>
              ...
              <p>
                Feel free to reach out via email at <a href="mailto:shivtrent800@gmail.com">shivtrent800@gmail.com</a>. I’m open to collaboration, mentorship, and opportunities in DevOps and cloud engineering.
              </p>
            </Card.Body>
